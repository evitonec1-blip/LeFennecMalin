...
export type AppTab =
  ...
  | 'canton-uri'
  | 'canton-schwyz'
  // Subsidies Hub & Cantonal Subsidy Pages (All 26 cantons)
  | 'hub-subsides'
  | 'subside-geneve'
  | 'subside-vaud'
  | 'subside-valais'
  ...
  | 'subside-soleure'
  | 'subside-schaffhouse'
  | 'subside-appenzell-ar'
  | 'subside-appenzell-ai'
  | 'subside-appenzell-rhodes-exterieures'
  | 'subside-appenzell-rhodes-interieures'
  | 'subside-grisons'
  | 'subside-glaris'
  | 'subside-nidwald'
  | 'subside-obwald'
