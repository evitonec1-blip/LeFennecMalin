...
const LIFE_ADVICE_MAPS: Record<string, Record<string, string>> = {
  ...
  es: {
    type: "El Pilar 3a ofrece deducciones fiscales directas pero está vinculado. El Pilar 3b es flexible con retiros libres.",
    personal: "La fecha de nacimiento, el cantón y los ingresos determinan el ahorro fiscal de tu 3er pilar.",
    product: "Elige entre cuenta de ahorro bancaria o fondos en acciones (ETF) para aumentar el rendimiento.",
    coverage: "Un seguro de vida integrado protege a tus seres queridos en caso de fallecimiento y te exonera del pago si quedas inválido.",
    savings: "Indica tu capacidad de ahorro. Cada franco ahorrado reduce tu renta imponible.",
    risk: "Tu perfil de riesgo define la cuota de acciones. A largo plazo, las acciones garantizan rendimientos superiores.",
    withdrawal: "La compra de vivienda, el trabajo independiente o la salida de Suiza permiten el retiro anticipado del 3a.",
    existing: "Un 3er pilar existente puede analizarse en costes para evaluar un traspaso ventajoso.",
    priority: "Define tu prioridad: reducir costes, aumentar el rendimiento, mantener la flexibilidad o garantizar la seguridad."
  },
  pt: {
    type: "O Pilar 3a oferece deduções fiscais diretas mas está vinculado. O Pilar 3b é flexível com levantamentos livres.",
    personal: "A data de nascimento, o cantão e os rendimentos determinam a poupança fiscal do seu 3º pilar.",
    product: "Escolha entre conta poupança bancária ou fundos em ações (ETF) para aumentar o rendimento.",
    coverage: "Um seguro de vida integrado protege os seus entes queridos em caso de falecimento e isenta-o do pagamento se ficar inválido.",
    savings: "Indique a sua capacidade de poupança. Cada franco poupado reduz o seu rendimento coletável.",
    risk: "O seu perfil de risco define a quota de ações. A longo prazo, as ações garantem rendimentos superiores.",
    withdrawal: "A compra de habitação, o trabalho independente ou a saída da Suíça permitem o levantamento antecipado do 3a.",
    existing: "Um 3º pilar existente pode ser analisado em custos para avaliar uma transferência vantajosa.",
    priority: "Defina a sua prioridade: reduzir custos, aumentar o rendimento, manter a flexibilidade ou garantir a segurança."
  }
};
...
const LIFE_UI_TEXTS: Record<string, Record<string, string>> = {
  fr: {
    ...
    legalLimits3aLabel: "Limites légales 3a :",
    salariedCapLabel: "Salarié(e) :",
    independentCapLabel: "Indépendant(e) :",
    yourSimulationLabel: "Votre simulation",
    pensionWordShort: "Prévoyance",
    adjustBtn: "Ajuster",
    officialWarningTitle: "Simulation basée sur les données actuarielles officielles AFC 2026",
    officialWarningDesc: "Cette simulation est indicative. Les montants réels varient selon votre situation et les conditions contractuelles de chaque assureur.",
    ...
    recoDesc: "Basé sur votre profil et vos priorités, cette stratégie optimise votre prévoyance tout en maximisant vos avantages fiscaux suisses.",
    ...
    desiredAnnualPaymentLabel: "Versement annuel souhaité :",
    legalSwissLimitLabel: "Plafond légal suisse 2026 :",
    eligibleAmountLabel: "Montant retenu (éligible) :",
    ...
    netAdminFeesLabel: "Frais administratifs nets :",
    cumulativeAdminFeesLabel: "Frais administratifs cumulés :",
    monthlyRiskPremiumsLabel: "Primes de risque mensuelles :",
    netSavingsPortionLabel: "Part nette d'épargne :",
    taxOptimizationLabel: "Optimisation Fiscale & Retrait",
    combinedMarginalRateLabel: "Taux marginal combiné",
    taxSavingsPerYearLabel: "Économie fiscale par an :",
    withdrawalTaxRateLabel: "Taux d'imposition au retrait :",
    taxPaidAtWithdrawalLabel: "Impôt payé au retrait :",
    ...
    pillar3aRegText: "Le pilier 3a (prévoyance liée) est ouvert aux personnes avec un revenu soumis à l'AVS. Les cotisations sont déductibles du revenu imposable dans les limites annuelles fixées par la Confédération. Les retraits sont imposés séparément à un taux réduit.",
    pillar3bRegText: "Le pilier 3b (prévoyance libre) n'a pas de plafond légal de cotisation. Ses avantages fiscaux varient selon les cantons.",
    simulationDisclaimer: "⚠️ Simulation avec des montants approximatifs. Ce comparateur ne constitue aucun engagement de la part de Le Fennec Malin ou des assureurs mentionnés.",
    ...
    privacyNoteLabel: "🔒 Vos données sont protégées conformément à la nLPD suisse. Aucune revente, aucun démarchage.",
  ...
  es: {
    heroTitle: "Simulador 3er Pilar y Previsión Suiza",
    heroSubtitle: "Encuentra la mejor estrategia de ahorro y reduce tus impuestos hasta CHF 3'000.- al año.",
    backBtn: "Atrás",
    continueBtn: "Continuar",
    verificationStepBtn: "Verificación de seguridad",
    step1Title: "1. ¿Qué tipo de 3er Pilar buscas?",
    step1Subtitle: "El 3er pilar te permite acumular un capital de jubilación ahorrando impuestos cada año.",
    p3aLabel: "Pilar 3a (Vinculado)",
    p3aDesc: "Máxima deducción fiscal",
    p3aDetails: "Vinculado por ley hasta la jubilación. Ideal para un alto ahorro fiscal.",
    p3bLabel: "Pilar 3b (Libre)",
    p3bDesc: "Total flexibilidad en los retiros",
    p3bDetails: "Sin restricciones de retiro. Ideal para ahorro flexible.",
    mixedLabel: "Mixto 3a + 3b",
    mixedDesc: "Lo mejor de ambos mundos",
    mixedDetails: "Combina la deducción fiscal del 3a con la flexibilidad del 3b.",
    step2Title: "2. ¿Cuánto deseas invertir al mes?",
    step2Subtitle: "Ajusta el importe mensual según tu capacidad de ahorro.",
    step3Title: "3. ¿Cuál es tu perfil?",
    step3Subtitle: "Tu perfil nos permite personalizar la simulación.",
    profileYoungLabel: "Joven Activo",
    profileYoungDesc: "Horizonte largo, mayor rendimiento",
    profileFamilyLabel: "Familia",
    profileFamilyDesc: "Seguridad y capital garantizado",
    profileSeniorLabel: "Senior",
    profileSeniorDesc: "Próximo a la jubilación",
    profileIndependentLabel: "Autónomo",
    profileIndependentDesc: "Sin 2º pilar, techo más alto",
    step4Title: "4. ¿Cuál es tu prioridad principal?",
    step4Subtitle: "Esto orienta la recomendación de producto.",
    priorityTaxLabel: "Máximo ahorro fiscal",
    priorityTaxDesc: "Pilar 3a vinculado, deducible al 100%",
    priorityYieldLabel: "Rendimiento Acciones",
    priorityYieldDesc: "Fondo de acciones, mayor potencial",
    prioritySecureLabel: "Capital Garantizado 100%",
    ...
    errEnter4Digits: "Por favor, introduce el código de 4 dígitos recibido por e-mail.",
    errIncorrectCode: "Código de verificación incorrecto.",
    errVerifyCode: "Error al verificar el código.",
    verifyingBtn: "Verificando...",
    validateCodeBtn: "Validar el código y ver los resultados",
    editDetailsBtn: "Modificar mis datos",
    fennyMessageTitle: "Mensaje de Fenny:",
    fennyMessageText: "\"Para validar tu expediente y presentarte las simulaciones certificadas del 3er pilar 2026, se ha generado un código de seguridad de 4 dígitos y enviado a {email}\"",
    yourEmail: "tu e-mail",
    footerCommitment: "Fenny se compromete: 100% anónimo, conforme a la nLPD suiza, sin venta de datos.",
    embeddedTitle: "Simula tu ahorro fiscal del 3er Pilar con Fenny",
    embeddedSubtitle: "Ahorra para tu jubilación mientras reduces tus impuestos suizos. Compara las ofertas de los principales aseguradores.",
    embeddedStat1: "Hasta CHF 3'000 de ahorro fiscal al año para asalariados",
    embeddedStat2: "Simulación personalizada de capital a término",
    embeddedStat3: "Neutral, independiente y conforme a la nLPD",
    embeddedBtn: "Iniciar la simulación del 3er Pilar",
    analyzingTitle: "Análisis fiscal y previsión...",
    restartBtn: "Volver a empezar",
    pensionTypeLabel: "Tipo de previsión:",
    pillar3aLinked: "Pilar 3a (Vinculado)",
    pillar3bFree: "Pilar 3b (Libre)",
    mixedShort: "Mixto",
    monthlyPaymentLabel: "Pago mensual:",
    contractDurationLabel: "Duración del contrato:",
    yourProfileLabel: "Tu perfil:",
    profileYoung: "Joven activo",
    profileFamily: "Familia",
    profileSenior: "Senior",
    profileIndependent: "Autónomo",
    majorPriorityLabel: "Prioridad principal:",
    priorityTaxSaving: "Máximo ahorro fiscal",
    priorityHighYield: "Rendimiento acciones",
    priorityGuaranteed: "Capital garantizado 100%",
    hideAdjustments2: "Ocultar ajustes",
    adjustSlidersDirectly: "Ajustar los controles directamente",
    monthlyPaymentShort: "Pago mensual",
    contractDurationShort: "Duración contractual",
    priorityFieldLabel: "Prioridad",
    legalLimits3aLabel: "Límites legales 3a:",
    salariedCapLabel: "Asalariado(a):",
    independentCapLabel: "Autónomo(a):",
    yourSimulationLabel: "Tu simulación",
    pensionWordShort: "Previsión",
    adjustBtn: "Ajustar",
    officialWarningTitle: "Simulación basada en datos actuariales oficiales AFC 2026",
    officialWarningDesc: "Esta simulación es orientativa. Los importes reales varían según tu situación y las condiciones contractuales de cada aseguradora.",
    estimatedTaxSavingsCardLabel: "Ahorro fiscal estimado",
    totalTaxReductionPrefix: "Equivale a una reducción fiscal total de aproximadamente",
    totalTaxReductionSuffix: "durante el período.",
    recommendationLabel: "Recomendación",
    recoMixed: "Opta por un modelo mixto Acciones/Bonos",
    recoGuaranteed: "Prioriza la seguridad del capital garantizado",
    recoTaxSaving: "Maximiza tu 3a vinculado para la ventaja fiscal",
    recoDesc: "Basado en tu perfil y prioridades, esta estrategia optimiza tu previsión maximizando tus ventajas fiscales suizas.",
    filterSortLabel: "Filtrar y ordenar las ofertas del 3er pilar",
    insurersAvailableLabel: "aseguradoras disponibles",
    allInsurersTab: "Todas las aseguradoras",
    maxYieldTab: "Máximo rendimiento (Acciones)",
    securityCapitalTab: "Seguridad & Capital",
    highestGuaranteedBadge: "Capital garantizado más alto",
    hideDetailsBtn: "Ocultar detalles",
    techSheetBtn: "Ficha técnica",
    yourProjectionLabel: "Tu Proyección",
    officialRegulationTitle: "Reglamentación Oficial AFC & Depósito Actuarial 2026",
    certifiedBadge: "CERTIFICADO SWISS-ACCURACY • 100% FIABLE",
    savingsLimitsLabel: "Ahorro & Límites",
    desiredAnnualPaymentLabel: "Pago anual deseado:",
    legalSwissLimitLabel: "Límite legal suizo 2026:",
    eligibleAmountLabel: "Importe retenido (elegible):",
    exceedsCapPrefix: "⚠️ El pago supera el límite suizo 3a (",
    exceedsCapSuffix: "). La simulación se ha ajustado legítimamente.",
    capStatusSalaried: "Asalariado",
    capStatusIndependent: "Autónomo",
    feesAndRiskPremiumsLabel: "Gastos & Primas de Riesgo",
    netAdminFeesLabel: "Gastos administrativos netos:",
    cumulativeAdminFeesLabel: "Gastos administrativos acumulados:",
    monthlyRiskPremiumsLabel: "Primas de riesgo mensuales:",
    netSavingsPortionLabel: "Parte neta de ahorro:",
    taxOptimizationLabel: "Optimización Fiscal & Retiro",
    combinedMarginalRateLabel: "Tipo marginal combinado",
    taxSavingsPerYearLabel: "Ahorro fiscal por año:",
    withdrawalTaxRateLabel: "Tipo impositivo en el retiro:",
    taxPaidAtWithdrawalLabel: "Impuesto pagado en el retiro:",
    actuarialSolvencyNoteLabel: "Nota actuarial de solvencia",
    solvencyNotePrefix: "Calculado con un rendimiento bursátil medio retenido del",
    solvencyNoteMiddle: "bruto. El ahorro fiscal acumulado en el período es de",
    solvencyNoteSuffix: "según el baremo oficial de la Confederación.",
    netRealCapitalPaidLabel: "Capital Neto Real Pagado (Payout)",
    afterTaxDeductionNote: "Tras deducción del impuesto separado sobre el retiro de capital",
    complianceRegElementsTitle: "Elementos reglamentarios de la Previsión Individual:",
    pillar3aRegText: "El pilar 3a (previsión vinculada) está abierto a personas con ingresos sujetos al AVS. Las cotizaciones son deducibles de la renta imponible dentro de los límites anuales fijados por la Confederación.",
    pillar3bRegText: "El pilar 3b (previsión libre) no tiene límite legal de cotización. Sus ventajas fiscales varían según los cantones.",
    simulationDisclaimer: "⚠️ Simulación con importes aproximados. Este comparador no constituye ningún compromiso de Le Fennec Malin ni de las aseguradoras mencionadas.",
    studyOfferedLabel: "Estudio de Previsión Gratuito",
    yourStudyLabel: "Tu estudio",
    summaryProjectionLabel: "Proyección resumida:",
    monthlySavingsPrefix: "Ahorro mensual de",
    monthlySavingsMiddle1: "durante",
    monthlySavingsMiddle2: "años. Capital final estimado (fondo):",
    monthlySavingsMiddle3: "en",
    monthlySavingsMiddle4: ". Ahorro fiscal medio acumulado:",
    monthlySavingsSuffix: "de ahorro de impuestos directos!",
    activityStatusLabel: "Tu situación laboral",
    salariedWithLpp: "Asalariado(a) (Con LPP)",
    independentWithoutLpp: "Autónomo(a) (Sin LPP)",
    formErrorMsg: "Por favor, rellena todos los campos obligatorios.",
    submitBtnLabel: "Solicitar mi estudio gratuito",
    privacyNoteLabel: "🔒 Tus datos están protegidos conforme a la nLPD suiza. Sin venta ni contacto abusivo.",
    simulationSavedTitle: "¡Simulación guardada!",
    thankYouPrefix: "Gracias",
    thankYouMiddle: "! Tu simulación fiscal del 3er pilar en",
    thankYouSuffix: "ha sido enviada a nuestro asesor de previsión.",
    followUpPrefix: "Prepararemos una comparativa de rendimiento personalizada integrando la deducción fiscal exacta según el baremo fiscal de tu cantón para",
    followUpMiddle: ". Te contactaremos al",
    followUpSuffix: "en 24 horas.",
    ...
    deathCoverageTitle: "Cobertura en caso de fallecimiento",
    yesLabel: "Sí",
    noLabel: "No",
    desiredDeathCapitalLabel: "Capital de fallecimiento deseado (CHF)",
    disabilityCoverageTitle: "Cobertura en caso de incapacidad laboral / invalidez",
    monthlyPensionOption: "Pensión mensual",
    disabilityNoneOption: "Ninguna",
    desiredMonthlyPensionLabel: "Pensión mensual deseada",
    pUnknownLabel: "Aún no lo sé",
    pUnknownDesc: "¡Ayúdame a elegir!",
    pUnknownDetails: "Permite estudiar ambas soluciones para componer la oferta más adecuada.",
    birthDateLabel: "Fecha de nacimiento del asegurado (DD.MM.AAAA) *",
    birthDatePlaceholder: "Ej: 28.05.1990",
    invalidDateErr: "⚠️ Fecha inválida o imposible",
    calculatedAge: "✓ Edad calculada:",
    yearsOld: "años",
    birthDateHelper: "Introduce los 8 dígitos de tu fecha de nacimiento.",
    genderLabel: "Sexo legal *",
    male: "Hombre",
    female: "Mujer",
    cantonLabel: "Cantón de residencia *",
    employmentLabel: "Situación profesional *",
    salaried: "Asalariado (con fondo de pensiones LPP)",
    independent: "Autónomo (sin fondo de pensiones)",
    unemployed: "Sin actividad lucrativa / Otro",
    incomeLabel: "Renta anual bruta (CHF)",
    hasSecondPillarLabel: "¿Ya afiliado a un 2º pilar (LPP)?",
    yes: "Sí",
    no: "No",
    pureSavings: "Ahorro puro",
    pureSavingsDesc: "Sin riesgo bursátil, capital garantizado.",
    equitySavings: "Ahorro en acciones (Fondos / ETF)",
    equitySavingsDesc: "Inversión bursátil para dinamizar el rendimiento a largo plazo.",
    mixedProduct: "Fórmula Mixta (Fondos + Seguro)",
    mixedProductDesc: "Combinación flexible de capital garantizado e inversión en acciones.",
    equityPartTitle: "¿Qué porcentaje de acciones buscas?",
    deathTitle: "Cobertura de fallecimiento complementaria",
    deathDesc: "Pago de un capital garantizado a tus familiares en caso de fallecimiento.",
    deathCapitalLabel: "Capital de fallecimiento deseado (CHF)",
    disabilityTitle: "Renta de invalidez",
    disabilityDesc: "Renta anual pagada en caso de incapacidad laboral.",
    premiumExemptionTitle: "Exención de primas",
    premiumExemptionDesc: "El asegurador paga en tu lugar en caso de invalidez.",
    dependentsTitle: "Personas a cargo",
    dependentsDesc: "Cónyuge o hijos a cargo legal.",
    frequencyLabel: "Frecuencia de pago",
    monthly: "Mensual",
    yearly: "Anual",
    estimatedSaving: "Pago estimado",
    estimatedTaxSavings: "Ganancia fiscal estimada: ~CHF",
    perYear: "/ año",
    perMonth: "/ mes",
    commitmentLabel: "Nivel de compromiso contractual",
    fixedRegular: "Fijo regular",
    fixedRegularDesc: "Previsión asegurada",
    bothCommitment: "Ambos",
    bothCommitmentDesc: "Solución híbrida",
    investmentHorizonLabel: "Horizonte de inversión",
    estimatedRetirementYear: "jubilación estimada en",
    yearsUnit: "años",
    temperamentLabel: "Tu temperamento ante las fluctuaciones",
    prudent: "Prudente (0-25% acciones)",
    prudentDesc: "Búsqueda de seguridad, ganancias moderadas.",
    balanced: "Equilibrado (25-50% acciones)",
    balancedDesc: "Compromiso perfecto entre crecimiento y estabilidad.",
    dynamic: "Dinámico (50-75% acciones)",
    dynamicDesc: "Dispuesto a aceptar subidas y bajadas moderadas.",
    offensive: "Ofensivo (100% acciones)",
    offensiveDesc: "Volatilidad máxima aceptada para un rendimiento óptimo.",
    marketDropTitle: "Si los mercados caen un 20% en pocos meses:",
    sellAll: "Lo vendo todo por miedo",
    holdWise: "Espero con paciencia",
    buyMore: "Aprovecho para reinvertir",
    esgTitle: "Fondos sostenibles / Criterios ESG únicamente",
    esgDesc: "Excluir armamento, carbón, etc. y favorecer lo ecorresponsable.",
    residenceOption: "Sí, para la compra de mi residencia principal",
    residenceOptionDesc: "Adquisición inmobiliaria o amortización hipotecaria.",
    independentOption: "Sí, para lanzarme como autónomo (LPP)",
    independentOptionDesc: "Creación de empresa individual o inicio de actividad comercial.",
    abroadOption: "Sí, porque planeo dejar Suiza",
    abroadOptionDesc: "Salida definitiva de la Confederación suiza.",
    noneOption: "No, ningún proyecto de retiro antes de la jubilación",
    noneOptionDesc: "Dejar crecer mi ahorro hasta la edad legal.",
    withdrawalHorizonTitle: "¿En qué horizonte estimas este retiro?",
    under5Years: "Menos de 5 años",
    from5to10Years: "5 a 10 años",
    over10Years: "Más de 10 años",
    hasPillarQuestion: "¿Tienes actualmente un 3er pilar?",
    hasPillarDesc: "Ya sea una cuenta bancaria o una póliza de seguro activa.",
    insurerNameLabel: "Nombre del asegurador/banco actual",
    accumulatedAmountLabel: "Importe ya acumulado (CHF)",
    stepGoalTitle: "¿Cuál es tu objetivo?",
    newContract: "Un nuevo contrato complementario",
    transferContract: "Transferencia / Rescate de mi contrato actual",
    step6Title: "6. Determina tu perfil de riesgo bursátil",
    step6Subtitle: "Si eliges asignar una parte de acciones, tu tolerancia determina la volatilidad máxima aceptable.",
    step7Title: "7. ¿Prevés un retiro anticipado del capital?",
    step7Subtitle: "En Suiza, la ley autoriza el retiro anticipado del Pilar 3a en casos específicos.",
    step8Title: "8. ¿Ya tienes un 3er Pilar?",
    step8Subtitle: "Si ya tienes un 3er pilar bancario o de seguro, podemos analizar si es más conveniente rescatarlo o complementarlo.",
    step9Title: "9. ¿Cuáles son tus prioridades de comparación?",
    step9Subtitle: "Haz clic en las opciones para asignar la prioridad n°1 y la prioridad n°2 de tu búsqueda de rendimiento y cobertura.",
    yieldPriority: "Rendimiento potencial más elevado",
    yieldPriorityDesc: "Asignación bursátil o títulos de alto rendimiento.",
    feesPriority: "Comisiones de entrada y costes de gestión más bajos",
    feesPriorityDesc: "Minimizar el impacto de los gastos administrativos.",
    flexibilityPriority: "Flexibilidad total de los pagos libres",
    flexibilityPriorityDesc: "Poder pagar lo que quieras, cuando quieras.",
    securityPriority: "Seguridad y capital garantizado contractualmente",
    securityPriorityDesc: "Sin riesgo bursátil sobre el ahorro acumulado.",
    coveragePriority: "Previsión completa (Seguros Fallecimiento/Invalidez)",
    coveragePriorityDesc: "Proteger al cónyuge y a los hijos de forma óptima.",
  ...
  pt: {
    heroTitle: "Simulador 3º Pilar e Previdência Suíça",
    heroSubtitle: "Encontre a melhor estratégia de poupança e reduza os seus impostos até CHF 3'000.- por ano.",
    backBtn: "Voltar",
    continueBtn: "Continuar",
    verificationStepBtn: "Verificação de segurança",
    step1Title: "1. Que tipo de 3º Pilar procura?",
    step1Subtitle: "O 3º pilar permite-lhe acumular um capital de reforma poupando impostos todos os anos.",
    p3aLabel: "Pilar 3a (Vinculado)",
    p3aDesc: "Máxima dedução fiscal",
    p3aDetails: "Vinculado por lei até à reforma. Ideal para uma alta poupança fiscal.",
    p3bLabel: "Pilar 3b (Livre)",
    p3bDesc: "Total flexibilidade nos levantamentos",
    p3bDetails: "Sem restrições de levantamento. Ideal para poupança flexível.",
    mixedLabel: "Misto 3a + 3b",
    mixedDesc: "O melhor dos dois mundos",
    mixedDetails: "Combina a dedução fiscal do 3a com a flexibilidade do 3b.",
    step2Title: "2. Quanto deseja investir por mês?",
    step2Subtitle: "Ajuste o montante mensal à sua capacidade de poupança.",
    step3Title: "3. Qual é o seu perfil?",
    step3Subtitle: "O seu perfil permite-nos personalizar a simulação.",
    profileYoungLabel: "Jovem Ativo",
    profileYoungDesc: "Horizonte longo, maior rendimento",
    profileFamilyLabel: "Família",
    profileFamilyDesc: "Segurança e capital garantido",
    profileSeniorLabel: "Sénior",
    profileSeniorDesc: "Próximo da reforma",
    profileIndependentLabel: "Independente",
    profileIndependentDesc: "Sem 2º pilar, teto mais alto",
    step4Title: "4. Qual é a sua prioridade principal?",
    step4Subtitle: "Isto orienta a recomendação de produto.",
    priorityTaxLabel: "Máxima poupança fiscal",
    priorityTaxDesc: "Pilar 3a vinculado, dedutível a 100%",
    priorityYieldLabel: "Rendimento Ações",
    priorityYieldDesc: "Fundo de ações, maior potencial",
    prioritySecureLabel: "Capital Garantido 100%",
    ...
    errEnter4Digits: "Por favor, introduza o código de 4 dígitos recebido por e-mail.",
    errIncorrectCode: "Código de verificação incorreto.",
    errVerifyCode: "Erro ao verificar o código.",
    verifyingBtn: "A verificar...",
    validateCodeBtn: "Validar o código e ver os resultados",
    editDetailsBtn: "Modificar os meus dados",
    fennyMessageTitle: "Mensagem de Fenny:",
    fennyMessageText: "\"Para validar o seu processo e apresentar-lhe as simulações certificadas do 3º pilar 2026, foi gerado um código de segurança de 4 dígitos e enviado para {email}\"",
    yourEmail: "o seu e-mail",
    footerCommitment: "Fenny compromete-se: 100% anónimo, conforme à nLPD suíça, sem venda de dados.",
    embeddedTitle: "Simule a sua poupança fiscal do 3º Pilar com Fenny",
    embeddedSubtitle: "Poupe para a sua reforma enquanto reduz os seus impostos suíços. Compare as ofertas dos principais seguradores.",
    embeddedStat1: "Até CHF 3'000 de poupança fiscal por ano para assalariados",
    embeddedStat2: "Simulação personalizada de capital a prazo",
    embeddedStat3: "Neutro, independente e conforme à nLPD",
    embeddedBtn: "Iniciar a simulação do 3º Pilar",
    analyzingTitle: "Análise fiscal e previdência...",
    restartBtn: "Recomeçar",
    pensionTypeLabel: "Tipo de previdência:",
    pillar3aLinked: "Pilar 3a (Vinculado)",
    pillar3bFree: "Pilar 3b (Livre)",
    mixedShort: "Misto",
    monthlyPaymentLabel: "Pagamento mensal:",
    contractDurationLabel: "Duração do contrato:",
    yourProfileLabel: "O seu perfil:",
    profileYoung: "Jovem ativo",
    profileFamily: "Família",
    profileSenior: "Sénior",
    profileIndependent: "Independente",
    majorPriorityLabel: "Prioridade principal:",
    priorityTaxSaving: "Máxima poupança fiscal",
    priorityHighYield: "Rendimento ações",
    priorityGuaranteed: "Capital garantido 100%",
    hideAdjustments2: "Ocultar ajustes",
    adjustSlidersDirectly: "Ajustar os controlos diretamente",
    monthlyPaymentShort: "Pagamento mensal",
    contractDurationShort: "Duração contratual",
    priorityFieldLabel: "Prioridade",
    legalLimits3aLabel: "Limites legais 3a:",
    salariedCapLabel: "Assalariado(a):",
    independentCapLabel: "Independente:",
    yourSimulationLabel: "A sua simulação",
    pensionWordShort: "Previdência",
    adjustBtn: "Ajustar",
    officialWarningTitle: "Simulação baseada em dados atuariais oficiais AFC 2026",
    officialWarningDesc: "Esta simulação é indicativa. Os montantes reais variam conforme a sua situação e as condições contratuais de cada segurador.",
    estimatedTaxSavingsCardLabel: "Poupança fiscal estimada",
    totalTaxReductionPrefix: "Equivale a uma redução fiscal total de aproximadamente",
    totalTaxReductionSuffix: "durante o período.",
    recommendationLabel: "Recomendação",
    recoMixed: "Opte por um modelo misto Ações/Obrigações",
    recoGuaranteed: "Priorize a segurança do capital garantido",
    recoTaxSaving: "Maximize o seu 3a vinculado para a vantagem fiscal",
    recoDesc: "Com base no seu perfil e prioridades, esta estratégia otimiza a sua previdência maximizando as suas vantagens fiscais suíças.",
    filterSortLabel: "Filtrar e ordenar as ofertas do 3º pilar",
    insurersAvailableLabel: "seguradores disponíveis",
    allInsurersTab: "Todos os seguradores",
    maxYieldTab: "Máximo rendimento (Ações)",
    securityCapitalTab: "Segurança & Capital",
    highestGuaranteedBadge: "Capital garantido mais alto",
    hideDetailsBtn: "Ocultar detalhes",
    techSheetBtn: "Ficha técnica",
    yourProjectionLabel: "A sua Projeção",
    officialRegulationTitle: "Regulamentação Oficial AFC & Depósito Atuarial 2026",
    certifiedBadge: "CERTIFICADO SWISS-ACCURACY • 100% FIÁVEL",
    savingsLimitsLabel: "Poupança & Limites",
    desiredAnnualPaymentLabel: "Pagamento anual desejado:",
    legalSwissLimitLabel: "Limite legal suíço 2026:",
    eligibleAmountLabel: "Montante retido (elegível):",
    exceedsCapPrefix: "⚠️ O pagamento ultrapassa o limite suíço 3a (",
    exceedsCapSuffix: "). A simulação foi ajustada legitimamente.",
    capStatusSalaried: "Assalariado",
    capStatusIndependent: "Independente",
    feesAndRiskPremiumsLabel: "Encargos & Prémios de Risco",
    netAdminFeesLabel: "Encargos administrativos líquidos:",
    cumulativeAdminFeesLabel: "Encargos administrativos acumulados:",
    monthlyRiskPremiumsLabel: "Prémios de risco mensais:",
    netSavingsPortionLabel: "Parte líquida de poupança:",
    taxOptimizationLabel: "Otimização Fiscal & Levantamento",
    combinedMarginalRateLabel: "Taxa marginal combinada",
    taxSavingsPerYearLabel: "Poupança fiscal por ano:",
    withdrawalTaxRateLabel: "Taxa de imposto no levantamento:",
    taxPaidAtWithdrawalLabel: "Imposto pago no levantamento:",
    actuarialSolvencyNoteLabel: "Nota atuarial de solvência",
    solvencyNotePrefix: "Calculado com um rendimento bolsista médio retido de",
    solvencyNoteMiddle: "bruto. A poupança fiscal acumulada no período é de",
    solvencyNoteSuffix: "segundo o baremo oficial da Confederação.",
    netRealCapitalPaidLabel: "Capital Líquido Real Pago (Payout)",
    afterTaxDeductionNote: "Após dedução do imposto separado sobre o levantamento de capital",
    complianceRegElementsTitle: "Elementos regulamentares da Previdência Individual:",
    pillar3aRegText: "O pilar 3a (previdência vinculada) está aberto a pessoas com rendimentos sujeitos ao AVS. As contribuições são dedutíveis do rendimento coletável dentro dos limites anuais fixados pela Confederação.",
    pillar3bRegText: "O pilar 3b (previdência livre) não tem limite legal de contribuição. As suas vantagens fiscais variam consoante os cantões.",
    simulationDisclaimer: "⚠️ Simulação com montantes aproximados. Este comparador não constitui qualquer compromisso do Le Fennec Malin ou dos seguradores mencionados.",
    studyOfferedLabel: "Estudo de Previdência Gratuito",
    yourStudyLabel: "O seu estudo",
    summaryProjectionLabel: "Projeção resumida:",
    monthlySavingsPrefix: "Poupança mensal de",
    monthlySavingsMiddle1: "durante",
    monthlySavingsMiddle2: "anos. Capital final estimado (fundo):",
    monthlySavingsMiddle3: "em",
    monthlySavingsMiddle4: ". Poupança fiscal média acumulada:",
    monthlySavingsSuffix: "de poupanças fiscais diretas!",
    activityStatusLabel: "A sua situação laboral",
    salariedWithLpp: "Assalariado(a) (Com LPP)",
    independentWithoutLpp: "Independente (Sem LPP)",
    formErrorMsg: "Por favor, preencha todos os campos obrigatórios.",
    submitBtnLabel: "Solicitar o meu estudo gratuito",
    privacyNoteLabel: "🔒 Os seus dados estão protegidos conforme à nLPD suíça. Sem venda nem contacto abusivo.",
    simulationSavedTitle: "Simulação guardada!",
    thankYouPrefix: "Obrigado",
    thankYouMiddle: "! A sua simulação fiscal do 3º pilar em",
    thankYouSuffix: "foi transmitida ao nosso consultor de previdência.",
    followUpPrefix: "Iremos preparar uma comparativa de rendimento personalizada integrando a dedução fiscal exata segundo o baremo fiscal do seu cantão para",
    followUpMiddle: ". Contactar-lo-emos ao",
    followUpSuffix: "em 24 horas.",
    ...
    deathCoverageTitle: "Cobertura em caso de falecimento",
    yesLabel: "Sim",
    noLabel: "Não",
    desiredDeathCapitalLabel: "Capital de falecimento desejado (CHF)",
    disabilityCoverageTitle: "Cobertura em caso de incapacidade de trabalho / invalidez",
    monthlyPensionOption: "Pensão mensal",
    disabilityNoneOption: "Nenhuma",
    desiredMonthlyPensionLabel: "Pensão mensal desejada",
    pUnknownLabel: "Ainda não sei",
    pUnknownDesc: "Ajuda-me a escolher!",
    pUnknownDetails: "Permite estudar ambas as soluções para compor a oferta mais adequada.",
    birthDateLabel: "Data de nascimento do segurado (DD.MM.AAAA) *",
    birthDatePlaceholder: "Ex: 28.05.1990",
    invalidDateErr: "⚠️ Data inválida ou impossível",
    calculatedAge: "✓ Idade calculada:",
    yearsOld: "anos",
    birthDateHelper: "Introduza os 8 dígitos da sua data de nascimento.",
    genderLabel: "Sexo legal *",
    male: "Homem",
    female: "Mulher",
    cantonLabel: "Cantão de residência *",
    employmentLabel: "Situação profissional *",
    salaried: "Assalariado (com fundo de pensões LPP)",
    independent: "Independente (sem fundo de pensões)",
    unemployed: "Sem atividade lucrativa / Outro",
    incomeLabel: "Rendimento anual bruto (CHF)",
    hasSecondPillarLabel: "Já filiado a um 2º pilar (LPP)?",
    yes: "Sim",
    no: "Não",
    pureSavings: "Poupança pura",
    pureSavingsDesc: "Sem risco bursátil, capital garantido.",
    equitySavings: "Poupança em ações (Fundos / ETF)",
    equitySavingsDesc: "Investimento bursátil para dinamizar o rendimento a longo prazo.",
    mixedProduct: "Fórmula Mista (Fundos + Seguro)",
    mixedProductDesc: "Combinação flexível de capital garantido e investimento em ações.",
    equityPartTitle: "Que percentagem de ações visa?",
    deathTitle: "Cobertura de falecimento complementar",
    deathDesc: "Pagamento de um capital garantido aos seus familiares em caso de falecimento.",
    deathCapitalLabel: "Capital de falecimento desejado (CHF)",
    disabilityTitle: "Renda de invalidez",
    disabilityDesc: "Renda anual paga em caso de incapacidade de trabalho.",
    premiumExemptionTitle: "Isenção de prémios",
    premiumExemptionDesc: "O segurador paga em seu lugar em caso de invalidez.",
    dependentsTitle: "Pessoas a cargo",
    dependentsDesc: "Cônjuge ou filhos a cargo legal.",
    frequencyLabel: "Frequência de pagamento",
    monthly: "Mensal",
    yearly: "Anual",
    estimatedSaving: "Pagamento estimado",
    estimatedTaxSavings: "Ganho fiscal estimado: ~CHF",
    perYear: "/ ano",
    perMonth: "/ mês",
    commitmentLabel: "Nível de compromisso contratual",
    fixedRegular: "Fixo regular",
    fixedRegularDesc: "Previdência assegurada",
    bothCommitment: "Ambos",
    bothCommitmentDesc: "Solução híbrida",
    investmentHorizonLabel: "Horizonte de investimento",
    estimatedRetirementYear: "reforma estimada em",
    yearsUnit: "anos",
    temperamentLabel: "O seu temperamento face às flutuações",
    prudent: "Prudente (0-25% ações)",
    prudentDesc: "Procura de segurança, ganhos moderados.",
    balanced: "Equilibrado (25-50% ações)",
    balancedDesc: "Compromisso perfeito entre crescimento e estabilidade.",
    dynamic: "Dinâmico (50-75% ações)",
    dynamicDesc: "Disposto a aceitar subidas e descidas moderadas.",
    offensive: "Ofensivo (100% ações)",
    offensiveDesc: "Volatilidade máxima aceite para um rendimento ótimo.",
    marketDropTitle: "Se os mercados caírem 20% em poucos meses:",
    sellAll: "Vendo tudo com medo",
    holdWise: "Aguardo com paciência",
    buyMore: "Aproveito para reinvestir",
    esgTitle: "Fundos sustentáveis / Critérios ESG apenas",
    esgDesc: "Excluir armamento, carvão, etc. e favorecer o eco-responsável.",
    residenceOption: "Sim, para a compra da minha residência principal",
    residenceOptionDesc: "Aquisição imobiliária ou amortização hipotecária.",
    independentOption: "Sim, para me lançar como independente (LPP)",
    independentOptionDesc: "Criação de empresa individual ou início de atividade comercial.",
    abroadOption: "Sim, porque planeio sair da Suíça",
    abroadOptionDesc: "Saída definitiva da Confederação suíça.",
    noneOption: "Não, nenhum projeto de levantamento antes da reforma",
    noneOptionDesc: "Deixar crescer a minha poupança até à idade legal.",
    withdrawalHorizonTitle: "Em que horizonte estima este levantamento?",
    under5Years: "Menos de 5 anos",
    from5to10Years: "5 a 10 anos",
    over10Years: "Mais de 10 anos",
    hasPillarQuestion: "Tem atualmente um 3º pilar?",
    hasPillarDesc: "Seja uma conta bancária ou uma apólice de seguro ativa.",
    insurerNameLabel: "Nome do segurador/banco atual",
    accumulatedAmountLabel: "Montante já acumulado (CHF)",
    stepGoalTitle: "Qual é o seu objetivo?",
    newContract: "Um novo contrato complementar",
    transferContract: "Transferência / Resgate do meu contrato atual",
    step6Title: "6. Determine o seu perfil de risco bursátil",
    step6Subtitle: "Se escolher alocar uma parte de ações, a sua tolerância determina a volatilidade máxima aceitável.",
    step7Title: "7. Prevê um levantamento antecipado do capital?",
    step7Subtitle: "Na Suíça, a lei autoriza o levantamento antecipado do Pilar 3a em casos específicos.",
    step8Title: "8. Já tem um 3º Pilar?",
    step8Subtitle: "Se já tem um 3º pilar bancário ou de seguro, podemos analisar se é mais vantajoso resgatá-lo ou complementá-lo.",
    step9Title: "9. Quais são as suas prioridades de comparação?",
    step9Subtitle: "Clique nas opções para atribuir a prioridade n°1 e a prioridade n°2 da sua pesquisa de rendimento e cobertura.",
    yieldPriority: "Rendimento potencial mais elevado",
    yieldPriorityDesc: "Alocação bursátil ou títulos de alto rendimento.",
    feesPriority: "Comissões de entrada e custos de gestão mais baixos",
    feesPriorityDesc: "Minimizar o impacto dos encargos administrativos.",
    flexibilityPriority: "Flexibilidade total dos pagamentos livres",
    flexibilityPriorityDesc: "Poder pagar o que quiser, quando quiser.",
    securityPriority: "Segurança e capital garantido contratualmente",
    securityPriorityDesc: "Sem risco bursátil sobre a poupança acumulada.",
    coveragePriority: "Previdência completa (Seguros Falecimento/Invalidez)",
    coveragePriorityDesc: "Proteger o cônjuge e os filhos de forma ótima.",
