      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-stone-50 p-6">
          <div className="max-w-md w-full bg-white rounded-2xl p-8 border border-stone-200 shadow-sm text-center">
            ...
            <h2 className="text-xl font-bold text-stone-900 mb-2">Une erreur est survenue</h2>
            <p className="text-sm text-stone-600 mb-6">
              L'application a rencontré un problème inattendu. Cliquez sur le bouton ci-dessous pour recharger la page.
            </p>
            <button
              onClick={() => window.location.reload()}
              className="w-full py-3 px-4 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-xl transition shadow-sm"
            >
              Recharger la page
            </button>
          </div>
