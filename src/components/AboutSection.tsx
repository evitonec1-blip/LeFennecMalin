...
export default function AboutSection() {
  ...
  const c = {
    ...
    es: {
      who_am_i: "¿Quién soy?",
      greeting: "¡Hola! Me llamo Fenny, el fennec inteligente",
      tagline: '"Inteligente para ti. Cerca de ti."',
      intro: "Soy la mascota oficial de Le Fennec Malin, tu comparador suizo de confianza para seguros y finanzas. ¿Mi objetivo? Simplificar la vida de las familias suizas y ayudarlas a ahorrar.",
      why_fennec: "¿Por qué un Fennec?",
      why_fennec_desc: "El fennec, o zorro del desierto, es un animal fascinante con características extraordinarias que reflejan un excelente comparador de seguros:",
      ear_title: "Grandes orejas para escuchar mejor:",
      ear_desc: "Al igual que el fennec percibe el menor ruido en el desierto, siempre estoy atento a tus necesidades de presupuesto y familia.",
      lightbulb_title: "Mente ágil y astuta:",
      lightbulb_desc: "En la compleja jungla de leyes (LAMal, LCA) y pilares (3a, 3b), analizo y selecciono las opciones más claras para ti.",
      mountain_title: "Resistente y cerca de ti:",
      mountain_desc: "Adaptado a climas extremos, te ayudo a afrontar los aumentos de primas 2026 en Suiza para proteger tu poder adquisitivo.",
      values_title: "Nuestros Valores Fundamentales",
      benevolence: "Atención",
      benevolence_desc: "Ponemos a tu familia y a las personas en el centro de todo.",
      transparency: "Transparencia Total",
      transparency_desc: "Sin información oculta, sin costes de intermediación.",
      reliability: "Fiabilidad Suiza",
      reliability_desc: "Cálculos precisos basados en los datos oficiales OFSP y Priminfo.",
      local: "Proximidad Local",
      local_desc: "Un equipo dedicado con sede en Suiza para responder a tus dudas.",
      free_title: "Un servicio de comparación gratuito: ¿cómo es posible?",
      free_desc: "Para mantener este servicio completamente independiente y gratuito, colaboramos con compañías de seguros asociadas. Si decides suscribir una oferta a través de nosotros, podríamos recibir una comisión de recomendación de los socios.",
      crucial_point: "Punto clave: Las primas del seguro básico (LAMal) están reguladas por el Estado y son idénticas tanto si contratas a través de nosotros como directamente con la caja. ¡Pagas exactamente el mismo precio!"
    },
    pt: {
      who_am_i: "Quem sou eu?",
      greeting: "Olá! Chamo-me Fenny, o fennec inteligente",
      tagline: '"Inteligente para si. Perto de si."',
      intro: "Sou a mascote oficial do Le Fennec Malin, o seu comparador suíço de confiança para seguros e finanças. O meu objetivo? Simplificar a vida das famílias suíças e ajudá-las a poupar.",
      why_fennec: "Porque um Fennec?",
      why_fennec_desc: "O fennec, ou raposa do deserto, é um animal fascinante com características extraordinárias que refletem um excelente comparador de seguros:",
      ear_title: "Grandes orelhas para ouvir melhor:",
      ear_desc: "Tal como o fennec percebe o menor ruído no deserto, estou sempre atento às suas necessidades de orçamento e família.",
      lightbulb_title: "Mente ágil e astuta:",
      lightbulb_desc: "Na complexa selva de leis (LAMal, LCA) e pilares (3a, 3b), analiso e seleciono as opções mais claras para si.",
      mountain_title: "Resistente e perto de si:",
      mountain_desc: "Adaptado a climas extremos, ajudo-o a enfrentar os aumentos de prémios 2026 na Suíça para proteger o seu poder de compra.",
      values_title: "Os Nossos Valores Fundamentais",
      benevolence: "Atenção",
      benevolence_desc: "Colocamos a sua família e as pessoas no centro de tudo.",
      transparency: "Transparência Total",
      transparency_desc: "Sem informação oculta, sem custos de intermediação.",
      reliability: "Fiabilidade Suíça",
      reliability_desc: "Cálculos precisos baseados nos dados oficiais OFSP e Priminfo.",
      local: "Proximidade Local",
      local_desc: "Uma equipa dedicada sediada na Suíça para responder às suas dúvidas.",
      free_title: "Um serviço de comparação gratuito: como é possível?",
      free_desc: "Para manter este serviço completamente independente e gratuito, colaboramos com companhias de seguros parceiras. Se decidir subscrever uma oferta através de nós, poderemos receber uma comissão de recomendação dos parceiros.",
      crucial_point: "Ponto fundamental: Os prémios do seguro de base (LAMal) são regulamentados pelo Estado e idênticos quer contrate através de nós quer diretamente com a caixa. Paga exatamente o mesmo preço!"
    }
  }[language] || {
    who_am_i: "Qui suis-je ?",
    greeting: "Bonjour ! Je m'appelle Fenny, le fennec malin",
