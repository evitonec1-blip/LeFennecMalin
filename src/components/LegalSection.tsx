...
export default function LegalSection({ mode }: LegalSectionProps) {
  ...
  const c = {
    ...
    es: {
      ...
      legal_subtitle: "Conformidad suiza, editor y política de responsabilidad",
      s1_title: "1. Editor del sitio",
      s1_desc: "El sitio lefennecmalin.ch es editado por la sociedad SAITHAMA Sàrl con sede en Cheseaux-sur-Lausanne, Suiza.",
      s2_title: "2. Alojamiento",
      s2_desc: "Alojado en servidores europeos altamente seguros (Google Cloud Platform, conforme a la nLPD suiza y al RGPD).",
      s3_title: "3. Propiedad intelectual",
      s3_desc: "La marca FENNY, el logotipo y la mascota Fenny son propiedad exclusiva de SAITHAMA Sàrl.",
      s4_title: "4. Limitación de responsabilidad",
      s4_desc: "Las simulaciones se proporcionan a título informativo basándose en los datos públicos OFSP (priminfo.admin.ch).",
      s5_title: "5. Independencia y neutralidad",
      s5_desc: "Le Fennec Malin es un comparador independiente sin participaciones de compañías de seguros.",
      privacy_title: "Política de Privacidad",
      privacy_subtitle: "Protección de tus datos personales según la nueva ley suiza (nLPD)",
      p1_title: "1. Transparencia",
      p1_desc: "Damos la máxima importancia a la protección de los datos de nuestros usuarios suizos de conformidad con la nLPD.",
      p2_title: "2. Datos recopilados",
      p2_desc: "Solo recopilamos los datos necesarios para elaborar el presupuesto o la simulación solicitada.",
      p3_title: "3. Uso de los datos",
      p3_desc: "Tus datos nunca se venden ni se ceden a terceros con fines publicitarios.",
      p4_title: "4. Tus derechos",
      p4_desc: "Tienes derecho a acceder, rectificar o eliminar tus datos personales en cualquier momento.",
      p5_title: "5. Cookies",
      p5_desc: "Utilizamos cookies técnicas esenciales para guardar la selección del cantón y los filtros de búsqueda."
    },
    pt: {
      legal_title: "Aviso Legal",
      legal_subtitle: "Conformidade suíça, editor e política de responsabilidade",
      s1_title: "1. Editor do site",
      s1_desc: "O site lefennecmalin.ch é editado pela sociedade SAITHAMA Sàrl com sede em Cheseaux-sur-Lausanne, Suíça.",
      s2_title: "2. Alojamento",
      s2_desc: "Alojado em servidores europeus altamente seguros (Google Cloud Platform, conforme à nLPD suíça e ao RGPD).",
      s3_title: "3. Propriedade intelectual",
      s3_desc: "A marca FENNY, o logótipo e a mascote Fenny são propriedade exclusiva da SAITHAMA Sàrl.",
      s4_title: "4. Limitação de responsabilidade",
      s4_desc: "As simulações são fornecidas a título informativo com base nos dados públicos OFSP (priminfo.admin.ch).",
      s5_title: "5. Independência e neutralidade",
      s5_desc: "Le Fennec Malin é um comparador independente sem participações de companhias de seguros.",
      privacy_title: "Política de Privacidade",
      privacy_subtitle: "Proteção dos seus dados pessoais segundo a nova lei suíça (nLPD)",
      p1_title: "1. Transparência",
      p1_desc: "Damos a máxima importância à proteção dos dados dos nossos utilizadores suíços em conformidade com a nLPD.",
      p2_title: "2. Dados recolhidos",
      p2_desc: "Recolhemos apenas os dados necessários para elaborar o orçamento ou a simulação solicitada.",
      p3_title: "3. Utilização dos dados",
      p3_desc: "Os seus dados nunca são vendidos nem cedidos a terceiros para fins publicitários.",
      p4_title: "4. Os seus direitos",
      p4_desc: "Tem o direito de aceder, retificar ou eliminar os seus dados pessoais a qualquer momento.",
      p5_title: "5. Cookies",
      p5_desc: "Utilizamos cookies técnicos essenciais para guardar a seleção do cantão e os filtros de pesquisa."
    }
  }[language] || {
    legal_title: "Mentions Légales",
    legal_subtitle: "Conformité suisse, éditeur et politique de responsabilité",
