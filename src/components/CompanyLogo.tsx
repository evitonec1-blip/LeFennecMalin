...
export default function CompanyLogo({ id, className = "w-16 h-16" }: CompanyLogoProps) {
  ...
  const specialUrls: Record<string, string> = {
    ...
    css: 'https://upload.wikimedia.org/wikipedia/commons/c/c2/CSS_Insurance_Logo.svg',
    helsana: 'https://upload.wikimedia.org/wikipedia/commons/b/b8/Helsana_logo.svg',
    swica: 'https://upload.wikimedia.org/wikipedia/commons/2/2a/Swica_Logo.svg',
    visana: 'https://upload.wikimedia.org/wikipedia/commons/3/3d/Visana_Logo.svg',
    ...
    groupemutuel: 'https://upload.wikimedia.org/wikipedia/commons/c/c8/Groupe_Mutuel_Logo.svg',
    mutuel: 'https://upload.wikimedia.org/wikipedia/commons/c/c8/Groupe_Mutuel_Logo.svg',
    avenir: 'https://upload.wikimedia.org/wikipedia/commons/c/c8/Groupe_Mutuel_Logo.svg',
    philos: 'https://upload.wikimedia.org/wikipedia/commons/c/c8/Groupe_Mutuel_Logo.svg',
    amb: 'https://upload.wikimedia.org/wikipedia/commons/c/c8/Groupe_Mutuel_Logo.svg',
    easysana: 'https://upload.wikimedia.org/wikipedia/commons/c/c8/Groupe_Mutuel_Logo.svg',
    kpt: 'https://upload.wikimedia.org/wikipedia/commons/6/67/KPT_Krankenkasse_Logo.svg',
    cpt: 'https://upload.wikimedia.org/wikipedia/commons/6/67/KPT_Krankenkasse_Logo.svg',
    sympany: 'https://upload.wikimedia.org/wikipedia/commons/7/7f/Sympany_Logo.svg',
    ...
    swisslife: 'https://upload.wikimedia.org/wikipedia/commons/7/77/Swiss_Life_Logo.svg',
    'swiss life': 'https://upload.wikimedia.org/wikipedia/commons/7/77/Swiss_Life_Logo.svg',
    axa: 'https://upload.wikimedia.org/wikipedia/commons/9/94/AXA_Logo.svg',
    zurich: 'https://upload.wikimedia.org/wikipedia/commons/f/fb/Zurich_Insurance_Group_logo.svg',
    helvetia: 'https://upload.wikimedia.org/wikipedia/commons/5/52/Helvetia_Versicherungen_logo.svg',
    allianz: 'https://upload.wikimedia.org/wikipedia/commons/4/4b/Allianz.svg',
    generali: 'https://upload.wikimedia.org/wikipedia/commons/0/04/Generali_logo.svg',
    vaudoise: 'https://upload.wikimedia.org/wikipedia/commons/a/a2/Vaudoise_Assurances_logo.svg',
    mobiliere: 'https://upload.wikimedia.org/wikipedia/commons/c/cd/La_Mobili%C3%A8re_logo.svg',
    baloise: 'https://upload.wikimedia.org/wikipedia/commons/c/cc/Baloise_Logo.svg',
  };
