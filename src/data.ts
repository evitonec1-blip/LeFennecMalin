...
export const CAISSES_MALADIE: CaisseMaladie[] = [
  { id: '8', name: 'CSS Assurance-maladie SA', rating: 5.1, ratingStars: 5, logo: 'CSS', basePrice: 0, isPartner: true, notes: 'Leader du marché, excellent accompagnement et service client' },
  { id: '32', name: 'Aquilana Versicherungen', rating: 5.2, ratingStars: 5, logo: 'AQ', basePrice: 0, isPartner: false, notes: 'Basé en Argovie, offre de très hauts standards d\'écoute et d\'efficience.' },
  { id: '134', name: 'Einsiedler Krankenkasse', rating: 5.1, ratingStars: 5, logo: 'KE', basePrice: 0, isPartner: false, notes: 'Assureur schwyzois engagé pour des démarches simplifiées et claires.' },
  { id: '194', name: 'Sumiswalder Krankenkasse', rating: 4.5, ratingStars: 4, logo: '194', basePrice: 0, isPartner: false, notes: 'Assureur agréé LAMal (OFSP) — descriptif à compléter.' },
  { id: '246', name: 'Genossenschaft Krankenkasse Steffisburg', rating: 5.2, ratingStars: 5, logo: 'ST', basePrice: 0, isPartner: false, notes: 'Forte présence bernoise avec primes stables et haute satisfaction client.' },
  { id: '290', name: 'CONCORDIA Assurance suisse de maladie et accidents SA', rating: 5.2, ratingStars: 5, logo: 'CC', basePrice: 0, isPartner: false, notes: 'Prestations familiales et primes enfants hautement préférentielles' },
  { id: '312', name: 'Atupri Assurance de la santé SA', rating: 4.8, ratingStars: 4, logo: 'AT', basePrice: 0, isPartner: false, notes: 'Modèles de prévention numérique modernes et innovants' },
  { id: '343', name: 'Avenir Assurance', rating: 4.8, ratingStars: 4, logo: 'AV', basePrice: 0, isPartner: true, notes: 'Membre du Groupe Mutuel avec solutions solides de base LAMal.' },
  { id: '360', name: 'Krankenkasse Luzerner Hinterland', rating: 5.2, ratingStars: 5, logo: 'LH', basePrice: 0, isPartner: false, notes: 'Excellent assureur lucernois à visage humain, très proche de ses membres.' },
  { id: '376', name: 'KPT Caisse-maladie SA', rating: 5.2, ratingStars: 5, logo: 'KPT', basePrice: 0, isPartner: true, notes: 'Caisse maladie en ligne moderne et processus entièrement dématérialisés' },
  { id: '455', name: 'ÖKK Kranken- und Unfallversicherungen AG', rating: 4.9, ratingStars: 4, logo: 'OKK', basePrice: 0, isPartner: false, notes: 'Orientation forte vers le sport, les loisirs et la prévention active' },
  { id: '509', name: 'Vivao Sympany SA', rating: 4.9, ratingStars: 4, logo: 'SY', basePrice: 0, isPartner: false, notes: 'Gestion transparente et remboursements directs sans complications' },
  { id: '780', name: 'Genossenschaft Glarner Krankenversicherung', rating: 5.0, ratingStars: 4, logo: 'GL', basePrice: 0, isPartner: false, notes: 'Caisse régionale de Glaris, offrant un accompagnement ultra-personnalisé.' },
  { id: '820', name: 'curaulta', rating: 4.5, ratingStars: 4, logo: '820', basePrice: 0, isPartner: false, notes: 'Assureur agréé LAMal (OFSP) — descriptif à compléter.' },
  { id: '881', name: 'EGK Grundversicherungen AG', rating: 4.5, ratingStars: 4, logo: '881', basePrice: 0, isPartner: false, notes: 'Assureur agréé LAMal (OFSP) — descriptif à compléter.' },
  { id: '923', name: 'Genossenschaft KRANKENKASSE SLKK', rating: 4.5, ratingStars: 4, logo: '923', basePrice: 0, isPartner: false, notes: 'Assureur agréé LAMal (OFSP) — descriptif à compléter.' },
  { id: '941', name: 'sodalis gesundheitsgruppe', rating: 5.1, ratingStars: 5, logo: 'SD', basePrice: 0, isPartner: false, notes: 'Assureur dynamique du Valais, offrant d\'excellents suivis de dossiers.' },
  { id: '966', name: 'vita surselva', rating: 4.5, ratingStars: 4, logo: '966', basePrice: 0, isPartner: false, notes: 'Assureur agréé LAMal (OFSP) — descriptif à compléter.' },
  { id: '1040', name: 'Verein Krankenkasse Visperterminen', rating: 5.0, ratingStars: 4, logo: 'VT', basePrice: 0, isPartner: false, notes: 'Caisse valaisanne ancrée localement avec une rigueur de gestion reconnue.' },
  { id: '1113', name: 'Caisse-maladie de la vallée d’Entremont société coopérative', rating: 4.5, ratingStars: 4, logo: '111', basePrice: 0, isPartner: false, notes: 'Assureur agréé LAMal (OFSP) — descriptif à compléter.' },
  { id: '1318', name: 'Stiftung Krankenkasse Wädenswil', rating: 5.1, ratingStars: 5, logo: 'WD', basePrice: 0, isPartner: false, notes: 'Structure zurichoise de proximité réputée pour sa gestion saine.' },
  { id: '1322', name: 'Krankenkasse Birchmeier', rating: 4.5, ratingStars: 4, logo: '132', basePrice: 0, isPartner: false, notes: 'Assureur agréé LAMal (OFSP) — descriptif à compléter.' },
  { id: '1384', name: 'SWICA Assurance-maladie SA', rating: 5.3, ratingStars: 5, logo: 'SW', basePrice: 0, isPartner: false, notes: 'Élue à plusieurs reprises meilleure satisfaction client de Suisse' },
  { id: '1386', name: 'Galenos AG', rating: 4.8, ratingStars: 4, logo: 'GA', basePrice: 0, isPartner: false, notes: 'Assureur suisse rigoureux axé sur la qualité de remboursement de base.' },
  { id: '1401', name: 'rhenusana', rating: 5.1, ratingStars: 5, logo: 'RH', basePrice: 0, isPartner: false, notes: 'Caisse rhénane indépendante misant sur une vraie écoute personnalisée.' },
  { id: '1479', name: 'Mutuel Assurance', rating: 4.8, ratingStars: 4, logo: 'MA', basePrice: 0, isPartner: true, notes: 'Partie du Groupe Mutuel, leader incontournable en Suisse Romande' },
  { id: '1507', name: 'AMB Assurances SA', rating: 4.8, ratingStars: 4, logo: 'AMB', basePrice: 0, isPartner: true, notes: 'Affiliée Groupe Mutuel, solutions de proximité polyvalentes.' },
  { id: '1509', name: 'Sanitas Grundversicherungen AG', rating: 5.1, ratingStars: 5, logo: 'SN', basePrice: 0, isPartner: true, notes: 'Application mobile de pointe pour un remboursement ultra-rapide' },
  { id: '1535', name: 'Philos Assurance', rating: 4.7, ratingStars: 4, logo: 'PH', basePrice: 0, isPartner: true, notes: 'Entité du Groupe Mutuel, axée sur les besoins spécifiques des familles.' },
  { id: '1542', name: 'Assura-Basis SA', rating: 4.5, ratingStars: 4, logo: 'AS', basePrice: 0, isPartner: true, notes: 'Modèles Telmed compétitifs et primes parmi les plus basses de Suisse' },
  { id: '1555', name: 'Visana AG', rating: 5.0, ratingStars: 4, logo: 'VS', basePrice: 0, isPartner: false, notes: 'Très bon service client de proximité et rabais complémentaires' },
  { id: '1560', name: 'Agrisano Krankenkasse AG', rating: 5.3, ratingStars: 5, logo: 'AG', basePrice: 0, isPartner: false, notes: 'Assureur dédié à la communauté agricole, primes historiquement très stables.' },
  { id: '1562', name: 'Helsana Assurances SA', rating: 5.1, ratingStars: 5, logo: 'HL', basePrice: 0, isPartner: true, notes: 'Réseau étendu de soins partenaires et grande réputation de qualité' },
  { id: '1568', name: 'sana24 AG', rating: 5.0, ratingStars: 4, logo: 'S24', basePrice: 0, isPartner: false, notes: 'Entité Visana offrant une large palette de couvertures de base.' },
];
